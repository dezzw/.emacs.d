...
(defun +activities-other-buffer-a (orig &rest args)
  "Advice around `other-buffer' to return an activity buffer when in an activity."
...
(defun +activities-sanitize-windows-h (&optional _activity)
  "Replace windows showing buffers from other activities with *scratch*.
Intended for `activities-after-resume-functions' and `activities-after-switch-functions'."
