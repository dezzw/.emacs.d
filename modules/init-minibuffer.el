...
(setup consult
  ...
  (:when-loaded
    ...
    (keymap-global-set "C-c f f" 'consult-recent-file)
    ...
    (keymap-global-set "C-c f y" 'consult-flymake)
    (keymap-global-set "C-c f m" 'consult-global-mark)
    (keymap-global-set "C-c f a" 'consult-org-agenda)
    (keymap-global-set "C-c f d" 'consult-fd)
